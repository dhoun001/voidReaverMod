...
import voidReaverMod.patches.relics.BottledPlaceholderField;
import voidReaverMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static voidReaverMod.DefaultMod.makeRelicOutlinePath;
import static voidReaverMod.DefaultMod.makeRelicPath;
